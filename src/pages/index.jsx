...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center px-2 justify-center min-h-screen ">
      <div className="flex flex-col items-center px-3 py-20 md:p-8 rounded-xl  box-shadow gap-4 md:w-[60%]">
        <div className="text-black text-3xl font-bold">Homnique Platform</div>

        <div className="text-2xl mt-4 mb-4">Several stuffs about Homnique</div>
        <div>
          <Link
            href="/auth/login"
